...
import methods.backbone_vit_for_ssf as backbone_vit
import methods.backbone_swin_for_ssf as backbone_swin
...
class net(nn.Module):
    ...
    def forward(self, img, reg=False):  # (B, 3, H, W)
    ...
    for ti, (x, _) in enumerate(novel_loader):
        ...
        for epoch in range(params.ft_epoch):
            ...
            for j in range(0, support_size, batch_size):
                ...
                scores, attns = model(x_batch, True)
